...
public class EmployeeString18_MultipleNameCriteria {
    public static void main(String[] args) {
        List<Employee18> employees = Arrays.asList(
            new Employee18(1, "Alice", 50000),
            new Employee18(2, "Bob", 60000),
            new Employee18(3, "Alexander", 55000),
            new Employee18(4, "Amanda", 65000),
            new Employee18(5, "Sam", 70000)
        );
...
class Employee18 {
    ...
    public Employee18(int id, String name, double salary) {
        this.id = id;
        this.name = name;
        this.salary = salary;
    }
    ...
    public String toString() {
        return "Employee18{id=" + id + ", name='" + name + "', salary=" + salary + "}";
    }
}
